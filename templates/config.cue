...
#Config: {
	...
	service: {
		...
		nodePort:  *32000 | int & >=30000 & <=32767
	}
...
#Instance: {
	...
	objects: {
		...
		npDenyAll: #NetworkPolicyDenyAll & {#config: config}
		npAllowIngress: #NetworkPolicyAllowIngress & {#config: config}
		npAllowEgress: #NetworkPolicyAllowEgress & {#config: config}
